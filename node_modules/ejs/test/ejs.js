...
suite('ejs.compile(str, options)', function () {
  ...
  test('throw if there are syntax errors', function () {
    try {
      ...
      assert.ok(err.message.indexOf('compiling ejs-locals') > -1);
  ...
  test('default to using ejs-locals.delimiter', function () {
    var fn;
    ejs.delimiter = '&';
...
suite('include()', function () {
  test('include ejs-locals', function () {
  ...
  test('include ejs-locals fails without `filename`', function () {
    try {
  ...
  test('strips BOM', function () {
    assert.equal(
      ejs.render('<%- include("fixtures/includes/bom.ejs-locals") %>',
        {}, {filename: path.join(__dirname, 'f.ejs')}),
      '<p>This is a file with BOM.</p>\n');
  });

  test('include ejs-locals with locals', function () {
    var file = 'test/fixtures/include.ejs';
    assert.equal(ejs.render(fixture('include.ejs'), {pets: users}, {filename: file, delimiter: '@'}),
        fixture('include.html'));
  });

  test('include ejs-locals with absolute path and locals', function () {
...
suite('require', function () {
  ...
  test('allow ejs-locals templates to be required as node modules', function () {
      var file = 'test/fixtures/include_preprocessor.ejs'
